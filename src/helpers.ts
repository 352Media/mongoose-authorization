...
export function resolveAuthLevel(schema, options, doc?) {
...
export function authIsDisabled(options) {
    return options && options.authLevel === false;
}

export function embedPermissions(schema, options, doc) {
...
export function sanitizeDocument(schema, options, doc) {
...
export function sanitizeDocumentList(schema, options, docs) {
...
export function getUpdatePaths(updates) {
